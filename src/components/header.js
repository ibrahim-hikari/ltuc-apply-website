            ...
            <header>
                ...
                <nav className="main-nav-mobile">
                    <ul>
                        ...
                        <li><a href="#programs" onClick={() => { $('.amman-container').fadeIn(); $('.irbid-container').fadeOut(); $('.main-nav-mobile').fadeOut(200); $('.amman-btn').addClass('clicked'); $('.irbid-btn').removeClass('clicked');}}>{context.headerData.nav.programs[0]}</a></li>
                        <li><a href="#programs" onClick={() => { $('.irbid-container').fadeIn(); $('.amman-container').fadeOut(); $('.main-nav-mobile').fadeOut(200); $('.irbid-btn').addClass('clicked'); $('.amman-btn').removeClass('clicked');}}>{context.headerData.nav.programs[1]}</a></li>
                ...
                <nav className="main-nav">
                    <ul>
                        ...
                        <li><a className='main-link' href="#programs" onClick={() => { $('.amman-container').fadeIn(); $('.irbid-container').fadeOut(); $('.amman-btn').addClass('clicked'); $('.irbid-btn').removeClass('clicked');}}>{context.headerData.nav.programs[0]}</a></li>
                        <li><a className='main-link' href="#programs" onClick={() => { $('.irbid-container').fadeIn(); $('.amman-container').fadeOut(); $('.irbid-btn').addClass('clicked'); $('.amman-btn').removeClass('clicked');}}>{context.headerData.nav.programs[1]}</a></li>
